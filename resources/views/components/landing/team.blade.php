<section id="team" class="scroll-mt-24 bg-gray-50/70 py-16 dark:bg-gray-900/30">
  <div class="mx-auto max-w-7xl px-4 lg:px-6">
    <x-ui.section-title title="Nuestro Equipo"
      subtitle="Este proyecto ha sido desarrollado por estudiantes de ingeniería de sistemas con el objetivo de crear una solución práctica a una problemática común: la falta de control financiero personal." />
